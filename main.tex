...
\usepackage{array}
\usepackage{tikz}
% Permitir tablas multipágina en apéndices
...
\usepackage[backend=biber,style=apa,sorting=nty,language=spanish]{biblatex}
...
% Cargar hyperref casi al final para evitar que otros paquetes sobreescriban sus parches
% y después de setspace/biblatex para preservar anclas de notas al pie.
\usepackage{hyperref}
\hypersetup{
  colorlinks=true,
  linkcolor=black,
  ...
  pdfkeywords={Hospital San Juan de Dios, imagen-síntoma, memoria colectiva}
}
\urlstyle{same}
