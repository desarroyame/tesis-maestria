...
\begin{figure}[h!]
    ...
    \caption{John Baldessari, \textit{Equestrian (Flesh) in Brackets with Orange Showdown}, 1992. (i) Acrylic on black and white photograph, in artist's frame. (ii) Acrylic on colour photograph, in artist's frame. (i) 48.25 x 43 in. (122.5 x 109.4 cm). (ii) 32 x 53 in. (81.2 x 134.9 cm). Overall: 68.5 x 96 in. (174 x 244.3 cm). Copyright The Artist.}
...
\begin{figure}[h]
    \includegraphics[width=\textwidth]{Pabellón San Lucas.png}
    \caption{Pabellón San Lucas (2001 y 2019). Foto: Juan Carlos Arroyo.}
\end{figure}
